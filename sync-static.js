...
function episodeBelongsToSeason(
  ...
  */
  ...
  /*
     ...
     Algunas temporadas usan el sufijo "-0"
     (una temporada dividida en cursos):

       stay-low-profile-sect-chief-1-0

     Sus episodios son:

       stay-low-profile-sect-chief-1-episodio-x1
       stay-low-profile-sect-chief-1-x1

     cuyo "base" es "stay-low-profile-sect-chief-1".

     Sin este ajuste TODOS los episodios se
     rechazan y la temporada nunca se completa.
  */

  const seasonBase =
    seasonSlug.replace(/-0$/, '');
